...
function displayPlaylist() {
  for(var k = 0; k < add2PlaylistInfo.length; k++) {
    ...
    var trackNo = document.createTextNode("track No. " + k + " ");         // Create a text node
    var info = document.createTextNode(add2PlaylistInfo[k]);               // Create a text node
    para.appendChild(trackNo);                                             // Append the text to <p>
    para.appendChild(info);                                                // Append the text to <p>
